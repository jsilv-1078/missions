...
export default function MarketPage(){
 ...
 return <main className="market-shell">
   ...
   <section className="method"><p>ABOUT THESE INDEXES</p><h3>Built like market benchmarks.</h3><p>Each sport is normalized around a 10,000-point Card Madness index. Live price movement and sales activity are filtered to reduce low-liquidity noise and extreme outliers.</p></section>
   <div className="nav-space"/><nav className="market-nav" style={{gridTemplateColumns:'repeat(6,1fr)'}}><a href="/">∿<small>Pulse</small></a><a className="on" href="/market">⌁<small>Market</small></a><button className="scan" aria-label="Scan card"><img src="/IMG_4838.jpeg" alt="" style={{width:34,height:34,objectFit:'cover',borderRadius:6,display:'block'}}/></button><a href="/collection-demo?view=collection">▥<small>My Collection</small></a><a href="/gauge">◎<small>Gauge</small></a><button>☰<small>More</small></button></nav>
 </main>
}
