...
export default function MarketPage(){
 ...
 return <main className="market-shell">
   ...
   <div className="nav-space"/><nav className="market-nav"><a href="/">∿<small>Pulse</small></a><a className="on" href="/market">⌁<small>Market</small></a><button className="scan" aria-label="Scan card"><img src="/IMG_4838.jpeg" alt="" style={{width:34,height:34,objectFit:'cover',borderRadius:6,display:'block'}}/></button><a href="/collection-demo?view=collection">▥<small>My Collection</small></a><button>☰<small>More</small></button></nav>
 </main>
}
