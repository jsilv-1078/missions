...
export default function MarketPage(){
 ...
 return <main className="market-shell">
   ...
   <div className="nav-space"/><nav className="market-nav" style={{gridTemplateColumns:'repeat(5,1fr)'}}><a href="/">∿<small>Pulse</small></a><a className="on" href="/market">⌁<small>Market</small></a><a href="/collection-demo?view=collection">▥<small>My Collection</small></a><a href="/gauge">◎<small>Gauge</small></a><button>☰<small>More</small></button></nav>
 </main>
}
