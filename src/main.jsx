...
function App(){
 ...
 return <div className="app">
  ...
  <main>
   ...
   <div className="missionTop"><span className="streak"><Zap/> New mission run</span><div className="runIntro"><small>COMPETITION MISSIONS</small><h2>Complete missions. Build your streak. Earn more.</h2><p>Mission Points reward consistent competition activity throughout the full 14-day run.</p><div className="missionRules"><span><Check/><b>Complete missions</b><small>Earn Mission Points for every mission completed.</small></span><span><Gift/><b>Finish all three</b><small>Complete all three daily missions to earn bonus points.</small></span><span><Zap/><b>Protect your streak</b><small>Longer daily streaks earn more points. If yours breaks, spend earned points to restore it.</small></span><span><Coins/><b>Lead for Mad Coin</b><small>The top Mission Point earner at halfway and competition completion receives bonus Mad Coin.</small></span></div></div><div className="missionStats"><span><b>{done.filter(Boolean).length}</b> completed</span><span><b>0</b> perfect days</span><span><b>{done.filter(Boolean).length*42}</b> mission points</span></div></div>
